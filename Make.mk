...
OBJS_CRT0 := ${MODTYPE}/src/startup/startup.o \
	$(TAGNAME).o
...
clean:
	rm -rf $(OBJS) $(OBJS_CRT0) $(AEABI_OBJS) $(OUTDIR)/$(TARGET).a $(OUTDIR)/$(TARGET_CRT0).o $(DOCDIR)

cleanall:
	rm -rf $(OBJS) $(OBJS_CRT0) $(AEABI_OBJS) $(OUTDIR) $(DOCDIR)
