...
/**
 * Temporary "live" resistance reading, in mOhm.
 * never wait for resistance stabilization cause it won't
 * Will be reset to zero on atomizer error.
 */
static volatile uint16_t Atomizer_tempTCRes;
